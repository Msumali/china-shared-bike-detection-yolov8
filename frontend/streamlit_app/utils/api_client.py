...
class APIClient:
    ...
    def get_video_info(self, file_id: str) -> Dict[str, Any]:
        ...
        return self._make_request("GET", f"/api/video/{file_id}/info")
    
    def delete_video(self, file_id: str) -> Dict[str, Any]:
        """Delete a video file."""
        return self._make_request("DELETE", f"/api/video/{file_id}")
    ...
    def get_detection_summary(self, file_id: str) -> Dict[str, Any]:
        ...
        return self._make_request("GET", f"/api/video/{file_id}/summary")
    ...
    def update_model_settings(self, settings: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._make_request("POST", "/api/model/settings", json=settings)
    ...
    def get_supported_formats(self) -> Dict[str, Any]:
        ...
        return self._make_request("GET", "/api/formats")
    ...
    def export_detections(self, file_id: str, format_type: str = "json") -> Dict[str, Any]:
        ...
        return self._make_request("GET", f"/api/video/{file_id}/export", params=params)
    
    def download_processed_video(self, file_id: str, task_id: str) -> Dict[str, Any]:
        """Download processed video with annotations."""
        return self._make_request("GET", f"/api/video/{file_id}/download/{task_id}")
    ...
    def start_stream_processing(self, stream_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._make_request("POST", "/api/stream/start", json=stream_config)
    
    def stop_stream_processing(self, stream_id: str) -> Dict[str, Any]:
        """Stop real-time stream processing."""
        return self._make_request("POST", f"/api/stream/stop/{stream_id}")
    
    def get_stream_status(self, stream_id: str) -> Dict[str, Any]:
        """Get stream processing status."""
        return self._make_request("GET", f"/api/stream/status/{stream_id}")
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return self._make_request("GET", "/api/metrics/performance")
    
    def get_detection_accuracy(self, file_id: str) -> Dict[str, Any]:
        """Get detection accuracy metrics for a video."""
        return self._make_request("GET", f"/api/video/{file_id}/accuracy")
    ...
    def save_detection_results(self, file_id: str, results: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return self._make_request("POST", f"/api/video/{file_id}/save_results", json=data)
    
    def get_saved_results(self, file_id: str) -> Dict[str, Any]:
        """Get saved detection results from database."""
        return self._make_request("GET", f"/api/video/{file_id}/saved_results")
    
    # Cleanup Methods
    def cleanup_temp_files(self) -> Dict[str, Any]:
        """Clean up temporary files."""
        return self._make_request("POST", "/api/cleanup/temp")
    
    def cleanup_old_results(self, days: int = 7) -> Dict[str, Any]:
        """Clean up old processing results."""
        params = {"days": days}
        return self._make_request("POST", "/api/cleanup/results", params=params)
    
    # Annotation Methods
    def get_annotations(self, file_id: str, frame_number: int) -> Dict[str, Any]:
        """Get annotations for a specific frame."""
        return self._make_request("GET", f"/api/video/{file_id}/annotations/{frame_number}")
    ...
    def save_annotations(self, file_id: str, frame_number: int, 
        ...
        return self._make_request("POST", f"/api/video/{file_id}/annotations/{frame_number}", json=data)
    ...
    def compare_frames(self, file_id: str, frame1: int, frame2: int) -> Dict[str, Any]:
        ...
        return self._make_request("POST", f"/api/video/{file_id}/compare", json=data)
    ...
    def compare_videos(self, file_id1: str, file_id2: str) -> Dict[str, Any]:
        ...
        return self._make_request("POST", "/api/compare/videos", json=data)
    
    # Validation Methods
    def validate_video(self, file_id: str) -> Dict[str, Any]:
        """Validate video file integrity."""
        return self._make_request("GET", f"/api/video/{file_id}/validate")
    
    def validate_detections(self, file_id: str, detections: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Validate detection results."""
        data = {"detections": detections}
        return self._make_request("POST", f"/api/video/{file_id}/validate_detections", json=data)
    
    # Thumbnail Methods
    def generate_thumbnail(self, file_id: str, frame_number: int = 0) -> Dict[str, Any]:
        """Generate thumbnail for a video."""
        params = {"frame_number": frame_number}
        return self._make_request("POST", f"/api/video/{file_id}/thumbnail", params=params)
    
    def get_thumbnail(self, file_id: str) -> Dict[str, Any]:
        """Get video thumbnail."""
        return self._make_request("GET", f"/api/video/{file_id}/thumbnail")
    ...
    def search_videos(self, query: str, filters: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        return self._make_request("POST", "/api/search/videos", json=data)
    
    def search_detections(self, query: str, filters: Dict[str, Any] = None) -> Dict[str, Any]:
        """Search detections by various criteria."""
        data = {"query": query, "filters": filters or {}}
        return self._make_request("POST", "/api/search/detections", json=data)
    ...
    def mark_notification_read(self, notification_id: str) -> Dict[str, Any]:
        ...
        return self._make_request("POST", f"/api/notifications/{notification_id}/read")
    ...
    def get_backup_status(self, backup_id: str) -> Dict[str, Any]:
        """Get backup status."""
        return self._make_request("GET", f"/api/backup/status/{backup_id}")
    
    def restore_backup(self, backup_id: str) -> Dict[str, Any]:
        """Restore from backup."""
        return self._make_request("POST", f"/api/backup/restore/{backup_id}")
    
    # User Management Methods (if multi-user)
    def get_user_info(self) -> Dict[str, Any]:
        """Get current user information."""
        return self._make_request("GET", "/api/user/info")
    
    def update_user_preferences(self, preferences: Dict[str, Any]) -> Dict[str, Any]:
        """Update user preferences."""
        return self._make_request("POST", "/api/user/preferences", json=preferences)
    ...
    def run_system_test(self) -> Dict[str, Any]:
        ...
        return self._make_request("POST", "/api/test/system")
    
    def test_detection_model(self) -> Dict[str, Any]:
        """Test detection model performance."""
        return self._make_request("POST", "/api/test/model")
